...
public class State {
    ...
    */
    ...
    public State(int[] agentRows, int[] agentCols, Color[] agentColors, boolean[][] walls,
                 char[][] boxes, Color[] boxColors, char[][] goals, int currentAgent
    ) {
    ...
    State(State parent, Action[] jointAction) {
        ...
        this.g = parent.g + 1;
        this.currentAgent = parent.currentAgent;
    ...
    public ArrayList<State> getExpandedStates() {
        ...
        for (int agent = 0; agent < numAgents; ++agent) {
            ...
            if (agent == this.currentAgent) {
                ...
                applicableActions[agent] = new Action[]{Action.NoOp};
            }
        }
